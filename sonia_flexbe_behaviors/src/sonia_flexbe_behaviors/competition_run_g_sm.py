...
from sonia_flexbe_behaviors.droppers_double_vision_task_sm import droppers_double_vision_taskSM
...
@author: William FA
'''
class CompetitionrunGSM(Behavior):
	'''
	Gate no trickshot task
Path task
Jiangshi task
Path task
Dropper double vision task
	'''


	def __init__(self):
		super(CompetitionrunGSM, self).__init__()
		self.name = 'Competition run G'

		# parameters of this behavior

		# references to used behaviors
		self.add_behavior(droppers_double_vision_taskSM, 'droppers_double_vision_task')
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('path_task_2',
										...
										transitions={'finished': 'droppers_double_vision_task', 'failed': 'stop control 2', 'lost_target': 'stop control 2'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit, 'lost_target': Autonomy.Inherit})
			...
			# x:499 y:427
			OperatableStateMachine.add('droppers_double_vision_task',
										self.use_behavior(droppers_double_vision_taskSM, 'droppers_double_vision_task'),
