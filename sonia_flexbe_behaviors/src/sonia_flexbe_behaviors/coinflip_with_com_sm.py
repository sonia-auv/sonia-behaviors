...
@author: FA
'''
class CoinFlipwithcomSM(Behavior):
	'''
	Orient to gate for coin flip task with the state for the underwater communication.
	'''


	def __init__(self):
		super(CoinFlipwithcomSM, self).__init__()
		self.name = 'CoinFlip with com'
