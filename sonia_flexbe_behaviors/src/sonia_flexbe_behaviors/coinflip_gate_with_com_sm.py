...
@author: FA
'''
class CoinFlipGatewithcomSM(Behavior):
	'''
	Orient to gate for coin flip task and starts to go to the gate with the state for the underwater communication.
	'''


	def __init__(self):
		super(CoinFlipGatewithcomSM, self).__init__()
		self.name = 'CoinFlip-Gate with com'
