...
@author: CS
'''
class vision_torpedoes_boards_newSM(Behavior):
	'''
	...
	def __init__(self):
		super(vision_torpedoes_boards_newSM, self).__init__()
		self.name = 'vision_torpedoes_boards_new'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('check_moving',
										...
										transitions={'stopped': 'get_torpedoes', 'moving': 'wait_target_reached', 'error': 'stop_filter_fail'},
			...
			OperatableStateMachine.add('init',
										...
										transitions={'continue': 'get_torpedoes'},
			...
			OperatableStateMachine.add('search_zigzag',
										...
										transitions={'finished': 'get_torpedoes', 'failed': 'stop_filter_fail', 'lost_target': 'stop_filter_lost', 'controller_error': 'stop_filter_fail'},
			...
			OperatableStateMachine.add('wait_target_reached',
										...
										transitions={'target_reached': 'get_torpedoes', 'target_not_reached': 'check_moving', 'error': 'stop_filter_fail'},
