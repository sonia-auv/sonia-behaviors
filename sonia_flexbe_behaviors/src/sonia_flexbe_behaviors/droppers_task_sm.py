	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('get_target',
										get_vision_target(bounding_box_pixel=75, target_width_meter=0.6, target_height_meter=0.3, ratio_victory=0.8, number_of_average=10, max_mouvement=1, min_mouvement=0.25, timeout=60),
