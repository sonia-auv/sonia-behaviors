	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('down',
										manual_add_pose_to_trajectory(positionX=0.0, positionY=0.0, positionZ=1.5, orientationX=0.0, orientationY=0.0, orientationZ=0.0, frame=1, speed=0, precision=0, long_rotation=False),
