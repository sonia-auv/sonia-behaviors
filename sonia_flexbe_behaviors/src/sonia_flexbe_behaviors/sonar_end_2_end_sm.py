...
class sonar_end_2_endSM(Behavior):
	...
	def __init__(self):
		...
		self.add_parameter('dist_to_torpedoes_board', 1.0)
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('down',
										manual_add_pose_to_trajectory(positionX=0.0, positionY=0.0, positionZ=1.0, orientationX=0.0, orientationY=0.0, orientationZ=0.0, frame=1, speed=2, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('set_initial_depth',
										manual_add_pose_to_trajectory(positionX=0.0, positionY=0.0, positionZ=0.5, orientationX=0.0, orientationY=0.0, orientationZ=0.0, frame=4, speed=0, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('up',
										manual_add_pose_to_trajectory(positionX=0.0, positionY=0.0, positionZ=-1, orientationX=0.0, orientationY=0.0, orientationZ=0.0, frame=1, speed=2, precision=0, long_rotation=False),
