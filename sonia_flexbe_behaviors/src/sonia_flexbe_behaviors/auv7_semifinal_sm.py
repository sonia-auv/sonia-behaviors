		...
		with _state_machine:
			...
			OperatableStateMachine.add('CoinFlip-Gate-Trickshot with com',
										self.use_behavior(CoinFlipGateTrickshotwithcomSM, 'CoinFlip-Gate-Trickshot with com',
											parameters={'submarine': "AUV7", 'dive_depth': 1.5, 'has_com': True, 'activate_coinflip_gate_trickshot_com': True}),
			...
			OperatableStateMachine.add('vision_buoys_new',
										self.use_behavior(vision_buoys_newSM, 'vision_buoys_new',
											parameters={'vision_buoys_target': "Badge", 'bounding_box_width': 100, 'bounding_box_height': 100, 'center_bounding_box_width': 50, 'center_bounding_box_height': 100, 'max_mouvement': 1.0, 'min_mouvement': 0.25, 'activate_vision_buoys': True}),
			...
			OperatableStateMachine.add('vision_path',
										self.use_behavior(vision_pathSM, 'vision_path',
											parameters={'vision_path_target': "pipe straight", 'min_mouvement': 0.25, 'max_mouvement': 1.2, 'bounding_box_height': 100, 'bounding_box_width': 30, 'center_bounding_box_height': 100, 'center_bounding_box_width': 100, 'activate_vision_path': True, 'move_after_path': 0}),
			...
			OperatableStateMachine.add('vision_path_2',
										self.use_behavior(vision_pathSM, 'vision_path_2',
											parameters={'vision_path_target': "pipe straight", 'min_mouvement': 0.25, 'max_mouvement': 1.2, 'bounding_box_height': 200, 'bounding_box_width': 30, 'center_bounding_box_height': 50, 'center_bounding_box_width': 50, 'move_after_path': 2.0}),
