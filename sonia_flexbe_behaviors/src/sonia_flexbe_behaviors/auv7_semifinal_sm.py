		...
		with _state_machine:
			...
			OperatableStateMachine.add('vision_buoys_new',
										self.use_behavior(vision_buoys_newSM, 'vision_buoys_new',
											parameters={'vision_buoys_target': "Badge", 'bounding_box_width': 100, 'bounding_box_height': 100, 'center_bounding_box_width': 100, 'center_bounding_box_height': 100, 'max_mouvement': 1.0, 'min_mouvement': 0.25, 'activate_vision_buoys': True}),
