	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('get_target',
										get_simple_vision_target(bounding_box_pixel=150, image_height=400, image_width=600, ratio_victory=0.5, number_of_average=10, max_mouvement=1, min_mouvement=0.25, timeout=60),
