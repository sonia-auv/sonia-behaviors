	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('check_moving',
										...
										transitions={'stopped': 'get_bins', 'moving': 'wait_align', 'error': 'stop_controller_error'},
			...
			OperatableStateMachine.add('get_bins',
										...
										transitions={'success': 'stop_success', 'align': 'align', 'move': 'align', 'failed': 'stop_failed', 'search': 'search_square'},
			...
			OperatableStateMachine.add('search_square',
										...
										transitions={'finished': 'get_bins', 'failed': 'stop_failed', 'lost_target': 'stop_lost_target', 'controller_error': 'stop_controller_error'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit, 'lost_target': Autonomy.Inherit, 'controller_error': Autonomy.Inherit},
										remapping={'target': 'target', 'topic': 'topic'})

			# x:761 y:287
			OperatableStateMachine.add('stop_controller_error',
										stop_filter_chain(),
			...
			OperatableStateMachine.add('wait_align',
										...
										transitions={'target_reached': 'get_bins', 'target_not_reached': 'check_moving', 'error': 'stop_controller_error'},
