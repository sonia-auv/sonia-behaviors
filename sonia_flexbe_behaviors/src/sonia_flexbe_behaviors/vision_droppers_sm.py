...
class vision_droppersSM(Behavior):
	...
	def __init__(self):
		...
		self.add_parameter('header_name', 'obstacle')
	...
	def create(self):
		# x:327 y:101, x:130 y:365, x:99 y:587, x:568 y:124
		...
		with _state_machine:
			...
			OperatableStateMachine.add('get_bins',
										get_simple_vision_target(bounding_box_pixel_height=70, bounding_box_pixel_width=130, image_height=400, image_width=600, number_of_average=10, max_mouvement=1, min_mouvement=0.1, long_rotation=False, timeout=10, speed_profile=0),
										transitions={'success': 'stop_success', 'align': 'align', 'move': 'align', 'failed': 'search_zigzag', 'search': 'search_zigzag'},
