	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('pose 1',
										add_pose_to_trajectory(positionX=0, positionY=0, positionZ=1, orientationX=0, orientationY=0, orientationZ=0, frame=1, speed=0, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 10',
										add_pose_to_trajectory(positionX=3.849, positionY=-1.364, positionZ=0.304, orientationX=0, orientationY=0, orientationZ=-39.23, frame=1, speed=1, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 2',
										add_pose_to_trajectory(positionX=0.5, positionY=0, positionZ=.5, orientationX=0, orientationY=0, orientationZ=self.angle_gate, frame=2, speed=1, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 5',
										add_pose_to_trajectory(positionX=3.849, positionY=-1.364, positionZ=-0.304, orientationX=0, orientationY=0, orientationZ=-39.923, frame=1, speed=1, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 6',
										add_pose_to_trajectory(positionX=1.079, positionY=0.383, positionZ=-0.196, orientationX=0, orientationY=0, orientationZ=39.23, frame=1, speed=0, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 7',
										add_pose_to_trajectory(positionX=1.75, positionY=1.721, positionZ=-0.314, orientationX=0, orientationY=0, orientationZ=90, frame=1, speed=1, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 8',
										add_pose_to_trajectory(positionX=1.721, positionY=1.75, positionZ=0.314, orientationX=0, orientationY=0, orientationZ=90, frame=1, speed=1, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose 9',
										add_pose_to_trajectory(positionX=1.079928, positionY=0.3833965, positionZ=0.19600, orientationX=0, orientationY=0, orientationZ=39.23, frame=1, speed=0, precision=0, long_rotation=False),
			...
			OperatableStateMachine.add('pose4',
										add_pose_to_trajectory(positionX=self.distance_start_loop, positionY=0, positionZ=0, orientationX=0, orientationY=0, orientationZ=0, frame=1, speed=1, precision=0, long_rotation=False),
