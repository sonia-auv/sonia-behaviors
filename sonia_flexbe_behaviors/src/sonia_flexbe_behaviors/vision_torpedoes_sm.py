...
class vision_torpedoesSM(Behavior):
	...
	def __init__(self):
		...
		self.add_parameter('vision_torpedoes_filterchain', 'simulation_gman')
		self.add_parameter('vision_torpedoes_target', 'gman')
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('detect_gman',
										start_filter_chain(filterchain=self.vision_torpedoes_filterchain, target=self.vision_torpedoes_target, camera_no=self.camera_no),
