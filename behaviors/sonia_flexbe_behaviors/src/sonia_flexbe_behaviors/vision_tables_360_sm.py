...
from sonia_flexbe_behaviors.search_360_sm import search_360SM
...
@author: GS
'''
class vision_tables_360SM(Behavior):
	'''
	...
	def __init__(self):
		super(vision_tables_360SM, self).__init__()
		self.name = 'vision_tables_360'
		...
		self.add_behavior(search_360SM, 'search_360')
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('get_bins',
										...
										transitions={'success': 'stop_success', 'align': 'align', 'move': 'align', 'failed': 'failed', 'search': 'search_360'},
			...
			# x:436 y:313
			OperatableStateMachine.add('search_360',
										self.use_behavior(search_360SM, 'search_360'),
										transitions={'finished': 'stop_lost_target', 'failed': 'failed', 'lost_target': 'lost_target', 'controller_error': 'controller_error'},
