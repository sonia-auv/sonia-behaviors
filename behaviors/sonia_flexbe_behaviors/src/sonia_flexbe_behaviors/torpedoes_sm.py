...
from sonia_flexbe_behaviors.vision_torpedoes_boards_new_sm import vision_torpedoes_boards_newSM
...
class torpedoesSM(Behavior):
	...
	def __init__(self):
		...
		self.add_behavior(vision_torpedoes_boards_newSM, 'vision_torpedoes_boards_new')
